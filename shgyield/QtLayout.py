...
class Ui_CustomWidget(object):
    def setupUi(self, CustomWidget):
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_8)
        ...
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.multiple_reflections)
        ...
        self.layers.addItem("")
        self.layers.addItem("")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.layers)
        self.label_12 = QtWidgets.QLabel(self.group_material)
        self.label_12.setEnabled(False)
        self.label_12.setObjectName("label_12")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_12)
        ...
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.box_thickness)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.box_energy_polar)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.box_energy_spect_min)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.box_energy_spect_max)
        ...
        self.sld_angle_theta.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.sld_angle_phi.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.sld_angle_gamma.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.formLayout_2.setLayout(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_3)
        ...
        self.sld_broad_eps.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.sld_broad_chi.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.formLayout_3.setLayout(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_5)
        ...
        self.sld_broad_out.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.formLayout_3.setLayout(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_6)
        self.verticalLayout.addWidget(self.group_broad)
        self.horizontalLayout_9.addWidget(self.widget, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
