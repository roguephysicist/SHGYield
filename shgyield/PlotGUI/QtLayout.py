...
class Ui_CustomWidget(object):
    def setupUi(self, CustomWidget):
        ...
        self.box_energy_polar.setMinimum(1.25)
        self.box_energy_polar.setMaximum(2.5)
        self.box_energy_polar.setSingleStep(0.01)
        ...
        self.box_energy_spect_min.setMaximum(10.0)
    ...
    def retranslateUi(self, CustomWidget):
        ...
        self.doubleSpinBox.setSuffix(_translate("CustomWidget", " nm"))
